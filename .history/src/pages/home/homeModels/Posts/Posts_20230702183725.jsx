...
const Posts = () => {
  ...
  const { getUserQuery } = useGetUsers(_id)
  const postsOfFollowingUsers = getPostsQuery?.data?.filter(
    (post) =>
      getUserQuery.data?.following.some(
        (followingUser) => followingUser.username === post.username,
      ) || getUserQuery.data?.username === post.username,
  )
  console.log(postsOfFollowingUsers, 'followingsdfsd')
  ...
  const fp = filteredPosts(postsOfFollowingUsers, filterBy)
  return (
    <>
