...
const Posts = () => {
  ...
  const isImage =
    post.file &&
    ['jpg', 'jpeg', 'png', 'gif'].includes(getFileExtension(post.file.name))
  const isVideo =
    post.file &&
    ['mp4', 'mov', 'avi'].includes(getFileExtension(post.file.name))
            ...
            <div className="post-content">
              ...
              <div>
                ...
                {post.file &&
                  ...
                  post.file && <img src={post.file} alt="Image Preview" />}
                {post.file &&
